...
//This class inherits from the stream_pv_base class
class stream_pv : public stream_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(stream_pv);
  stream_pv(sc_core::sc_module_name module_name);   
