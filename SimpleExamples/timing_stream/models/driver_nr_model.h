...
class driver_nr_pv_base;
class driver_nr_pv_base_mb_compatibility : public mb::mb_module {
  friend class driver_nr_pv_base;
 public:
  typedef unsigned int mb_address_type;
 protected:
  driver_nr_pv_base_mb_compatibility(sc_core::sc_module_name& module_name)
    : mb::mb_module(module_name) {}
 
};

class driver_nr_pv_base : public driver_nr_pv_base_mb_compatibility {
 private:
  typedef driver_nr_pv_base_mb_compatibility mb_compatibility_class;
 public:
  typedef esl::tlm_types::Address mb_address_type;
 public:
  typedef driver_nr_pv_base self;
  SC_HAS_PROCESS(driver_nr_pv_base);
  driver_nr_pv_base(sc_core::sc_module_name& module_name);
...
class driver_nr_machine_arch : public MachineArch { 
...
class driver_nr_t_base : public papoulis::SystemCBaseModel {
public:
  static driver_nr_t_base* create_t(const char* _name, long simulation);
public:
  driver_nr_t_base(sc_core::sc_module_name& module_name, long simulation);
...
public:
  virtual driver_nr_machine_arch* getMachineArch() const {
...
protected:
  ...
  driver_nr_machine_arch* m_machineArch;

protected:
  friend class driver_nr_model;
...
class driver_nr_pvt_param_defaults {
  
public:
  driver_nr_pvt_param_defaults(const char* hier_name) {
...
class driver_nr_pvt : public esl::sc_sim::PVTBaseModel, 
                          public mb::utl::cb_owner, 
                          private driver_nr_pvt_param_defaults {

 public:
  typedef driver_nr_pvt self_type;

 public: 
  // Constructor
  driver_nr_pvt(sc_core::sc_module_name module_name); 
  ~driver_nr_pvt(); 

 public:
    //access the T instance
  inline driver_nr_t_base* getT() const {
    return m_driver_nr_t;
  }
  
  //access the PV instance
  inline driver_nr_pv* getPV() const {
    return m_driver_nr_pv;
  }
 ...
 private:
  //T instance
  driver_nr_t_base* m_driver_nr_t;
  
  //PV instance
  driver_nr_pv* m_driver_nr_pv;
 ...
 private:
  ...
  struct y_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    driver_nr_pvt& m_owner;
    y_nb_connector(driver_nr_pvt& owner) : m_owner(owner) {
    }
