...
//This class inherits from the AXI_APB_pv_base class
class AXI_APB_pv : public AXI_APB_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(AXI_APB_pv);
  AXI_APB_pv(sc_core::sc_module_name module_name);   
