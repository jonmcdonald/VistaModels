...
//* Automatically merged on: May. 18, 2015 09:26:03 AM, (user: markca)
//*>
...
//This class inherits from the TestBench_pv_base class
class TestBench_pv : public TestBench_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(TestBench_pv);
  TestBench_pv(sc_core::sc_module_name module_name);  
  
 protected:
  /////////////////////////////////////////
  // write callbacks of registers
  ////////////////////////////////////////// 
  void cb_write_ACK(unsigned int newValue); 

protected:
  // SC_THREAD created for testbench
  void thread();    
  sc_event  e1;
 ...
 protected:
  ...
  virtual void cb_transport_dbg_ACK(tlm::tlm_generic_payload& trans); 
