...
SC_MODULE(SecurityAttack) {
public:
  typedef SecurityAttack SC_CURRENT_USER_MODULE;
  SecurityAttack(::sc_core::sc_module_name name):
...
CanIF(0)
$end
$init("securityattackdriver0"),
securityattackdriver0(0)
$end
    $initialization_end
{
    $elaboration_begin;
...
$end;
$bind("securityattackdriver0->m","CanIF->reg");
vista_bind(securityattackdriver0->m, CanIF->reg);
$end;
    $elaboration_end;
  $vlnv_assign_begin;
m_library = "local";
...
$end;
$destruct_component("securityattackdriver0");
delete securityattackdriver0; securityattackdriver0 = 0;
$end;
    $destructor_end;
  }
public:
