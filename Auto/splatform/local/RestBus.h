...
SC_MODULE(RestBus) {
public:
  typedef RestBus SC_CURRENT_USER_MODULE;
  RestBus(::sc_core::sc_module_name name):
...
$end;
$bind("restbusdriver0->m","CanIF->reg");
vista_bind(restbusdriver0->m, CanIF->reg);
$end;
    $elaboration_end;
  $vlnv_assign_begin;
m_library = "local";
...
$end;
$destruct_component("restbusdriver0");
delete restbusdriver0; restbusdriver0 = 0;
$end;
    $destructor_end;
  }
public:
