...
//This class inherits from the AccelDriver_pv_base class
class AccelDriver_pv : public AccelDriver_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(AccelDriver_pv);
  AccelDriver_pv(sc_core::sc_module_name module_name);       
