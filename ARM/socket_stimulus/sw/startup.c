...
void (* const g_pfnVectors[])(void) =
{
    ...
    irq0_Handler,               /* Interrupt Handler */
    irq1_Handler                /* Interrupt Handler */
};
...
{
  print_UART0("FAIL: Default_Handler\n");
...
{
  print_UART0("FAIL: HardFault_Handler\n");
  /* Go into an infinite loop. */
  while (1) 
  {
  }
...
{
  print_UART0("FAIL: UsageFault_Handler\n");
  /* Go into an infinite loop. */
  while (1) 
  {
  }
