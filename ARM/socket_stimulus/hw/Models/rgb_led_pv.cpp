...
//* Automatically merged on: Jul. 24, 2014 01:00:20 PM, (user: markca)
//*>
...
bool rgb_led_pv::slave_callback_read(mb_address_type address, unsigned char* data, unsigned size) {
...
// Returns true when successful.
bool rgb_led_pv::slave_callback_write(mb_address_type address, unsigned char* data, unsigned size) {
...
unsigned rgb_led_pv::slave_callback_read_dbg(mb_address_type address, unsigned char* data, unsigned size) {
  return 0;
} 

unsigned rgb_led_pv::slave_callback_write_dbg(mb_address_type address, unsigned char* data, unsigned size) {
  return 0;
} 

bool rgb_led_pv::slave_get_direct_memory_ptr(mb_address_type address, tlm::tlm_dmi& dmiData) {
  return false;
}
