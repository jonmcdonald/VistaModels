...
#include "AXIAPB_model.h"

using namespace tlm;

//This class inherits from the AXIAPB_pv_base class
class AXIAPB_pv : public AXIAPB_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(AXIAPB_pv);
  AXIAPB_pv(sc_core::sc_module_name module_name);    
