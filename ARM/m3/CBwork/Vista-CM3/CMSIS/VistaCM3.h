...
typedef struct
{
  __IO uint32_t Data;                       /*!< Offset: 0x0000 (R/W)  Data Register           */
       uint32_t RESERVED1[15];
  union {
      struct {
        __I uint32_t Empty :1;              /*!< Status: Empty flag                            */
        __I uint32_t nEmpty:1;              /*!< Status: not Empty flag                        */
        __I uint32_t Few   :1;              /*!< Status: Few elements in the fifo (<= 2)       */
  ...
  __IO uint32_t Count;                      /*!< Offset: 0x0044 (R/W)  Count Register          */
       uint32_t RESERVED2[2];
  __IO uint32_t ClearIRQ;                   /*!< Offset: 0x0050 (R/W)  Clear IRQ Register      */
...
typedef struct
{
  __I  uint32_t haveData;                   /*!< Offset: 0x0000 (R/-)  haveData Register           */
  __IO uint32_t STATUS;                     /*!< Offset: 0x0004 (R/W)  Status Register         */
...
/* Peripheral memory map */
#define Vista_FIFO0_BASE         (Vista_PERIPH_BASE + 0x0000) /*!< (SuperFIFO0    ) Base Address */
