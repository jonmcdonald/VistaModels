...
function  WWHTabs_BodyHTML_MGC()
{
  ...
  TabsHTML += "<table width=100% border=0 cellspacing=0 cellpadding=0>\n";
  MaxTabIndex = 4;
  for (MaxIndex = MaxTabIndex, Index = 0 ; Index < MaxIndex ; Index++)
  {
    ...
    TabsHTML += "<" + CellType + "class=\"tab\" width=\"" + TabWidth[Index] + "\" nowrap " + OnClick + ">";
  ...
  TabsHTML += "<" + CellType + " bgcolor=\"#FFFFFF\" nowrap " + "><img src=\"../../common/images/spc5w1h.gif\" border=\"0\" /></" + CellType + ">";
  TabsHTML += "<" + CellType + " nowrap bgcolor=\"#FFFFFF\" " + "><a href=\"javascript:WWHFrame.MGC_Display_Single_Topic()\" title=\"Hide Contents, Index, Search Tabs\"><img src=\"" + CloseGif + "\" border=0 vspace=0 /></" + CellType + "></a>";
//  TabsHTML += "<tr bgcolor=\"#416E98\"><td class=\"3px\" bgcolor=\"#416E98\" height=\"5\" colspan=6>&nbsp;</td></tr>";
  TabsHTML += "</tr>\n";
//  TabsHTML += "<tr height=\"5\" bgcolor=\"#416E98\"><td bgcolor=\"#416E98\" colspan=\"6\"></td></tr>";

//       var closebutton = "<td><a href=\"javascript\:top.close\(\)\"><img src=\"../images/close_button.gif\" title=\"Close Window\" height=\"27\" border=\"0\"  /></a></td>\n";
