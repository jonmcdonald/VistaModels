...
//  StylesHTML += "    " + WWHFrame.WWHJavaScript.mSettings.mTabs.mFontStyle + ";\n";
//  StylesHTML += "  }\n";
  StylesHTML += "  table.MGCtab\n";
  StylesHTML += "  {\n";
  StylesHTML += "    background-color: white\;\n";
  StylesHTML += "    height: 22px\;\n";
  StylesHTML += "    border-width: 1px\;";
  StylesHTML += "    border-spacing: 0px\;";
  StylesHTML += "    border-style: none\;";
  StylesHTML += "    border-color: white\;";
  StylesHTML += "  }\n";
  StylesHTML += "  td.MGCtab\n";
  StylesHTML += "  {\n";
  StylesHTML += "    height: 22px\;\n";
  StylesHTML += "    font-size: 0px\;\n";
  StylesHTML += "    background-color: white\;\n";
  StylesHTML += "    padding: 0\;";
  StylesHTML += "  }\n";
  StylesHTML += "  div.MGCTab\n";
  StylesHTML += "  {\n";
  StylesHTML += "    border: 0px solid white\;\n";
...
function  WWHTabs_BodyHTML_MGC()
{
  ...
  //
  TabsHTML += "<div border=1 style=\"position: relative\; background-color:#FFFFFF\; left:0px\;top:0px\; height:3px\; font-size:2px\; \" ><img src=\"../../common/images/spc5w1h.gif\" vspace=0 border=\"0\" /></div>";
  TabsHTML += "<table class='MGCtab' cellspacing=0 cellpadding=0>\n";
  MaxTabIndex = 4;
  for (MaxIndex = MaxTabIndex, Index = 0 ; Index < MaxIndex ; Index++)
  {
    ...
    VarTabImage = "<img src=\"../../common/images/" + ActiveTabImage[Index] + "\" border=\"0\" hspace=\"0\" vspace=\"0\" />";
    if ( (Index == 3) && (WWHFrame.OnSupportNet) )
    {
       VarTabImage = "<img src=\"../../common/images/mytopics_disable.png\" border=\"0\" hspace=\"0\" vspace=\"0\" />";
    }
    ...
    if (Index == WWHFrame.WWHJavaScript.mCurrentTab) 
    {
      ...
      WrapPrefix = "<a name=\"tab" + Index + "\" href=\"javascript:void(0);\"" + VarAccessibilityTitle + ">";
      if ( (Index == 3) && (WWHFrame.OnSupportNet) )
      {
         WrapPrefix = "<a name=\"tab" + Index + "\" href=\"javascript:void(0);\"" + "title='My Topics is NOT Available on SupportNet'" + ">";
      }
      WrapSuffix = "</a>";
      OnClick = "";
    }
    ...
    {
      VarTabImage = "<img src=\"../../common/images/" + NonActiveTabImage[Index] + "\" border=\"0\" hspace=\"0\" vspace=\"0\" />";
      if ( (Index == 3) && (WWHFrame.OnSupportNet) )
      {
        VarTabImage = "<img src=\"../../common/images/mytopics_disable.png\" border=\"0\" hspace=\"0\" vspace=\"0\" />";
      }
      ...
      if (Index != 0)
         { WrapPrefix = "<a name=\"tab" + Index + "\" href=\"javascript:WWHFrame.WWHJavaScript.fClickedChangeTab(" + Index + ");\"" + VarAccessibilityTitle + ">"; }
      else
        { WrapPrefix = "<a name=\"tab" + Index + "\" href=\"javascript:MGC_ShowContents();\"" + VarAccessibilityTitle + ">"; }
    ...
    TabsHTML += "<td class='MGCtab'" + OnClick + ">";
    if (Index == 0) { TabsHTML += "<div class='MGCTab' id='ContentTab'>\n"; }
    if (Index == 3) { TabsHTML += "<div class='MGCTab' id='MyTopicsTab'>\n"; }
    TabsHTML += WrapPrefix;
  ...
  TabsHTML += "<td class='MGCtab'><img src=\"../../common/images/spc5w1h.gif\" vspace=0 border=\"0\" /></td>\n";
  TabsHTML += "<td class='MGCtab'><a href=\"javascript:WWHFrame.MGC_Display_Single_Topic()\" title=\"Hide Contents, Index, Search Tabs\"><img src=\"" + CloseGif + "\" border=\"0\" hspace=\"0\" vspace=\"0\" /></a></td>\n";
  TabsHTML += "</tr>\n";
