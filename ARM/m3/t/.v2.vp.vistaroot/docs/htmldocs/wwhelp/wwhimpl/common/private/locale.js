...
function  WWHCommonMessages_Set_en(ParamMessages)
{
  // Icon Labels
  //
  ParamMessages.mShowNavigationIconLabel = "Show Contents, Index, & Search Tabs";
  ParamMessages.mSyncIconLabel           = "Highlight Topic in Content Tab";
  ParamMessages.mPrevIconLabel           = "Display Previous Topic";
  ParamMessages.mNextIconLabel           = "Display Next Topic";
  ParamMessages.mRelatedTopicsIconLabel  = "Related Topics";
  ParamMessages.mEmailIconLabel          = "E-mail Your Feedback";
  ParamMessages.mPDFIconLabel            = "Display PDF for this Book";
  ParamMessages.mBookcaseIconLabel       = "Display Bookcase";
  ParamMessages.mPrintIconLabel          = "Print Current Topic";
