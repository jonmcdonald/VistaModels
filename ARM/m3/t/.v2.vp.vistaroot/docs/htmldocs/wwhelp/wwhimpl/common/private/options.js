...
{
  this.mTitle = "_a_search_tips";

  this.mbCookies            = true;
  this.mCookiesDaysToExpire = 30;
  this.mCookiesID           = "OTNQITKO";
...
function  WWHCommonSettings_RelatedTopics_Object()
{
  ...
  this.mTitleFontStyle = "font-family: Verdana, Arial, Helvetica, sans-serif ; font-size: " + (WWHFrame.BaseNavFontSize-2) + "px";
...
//  this.mFontStyle       = "font-family: Verdana, Arial, Helvetica, sans-serif ; font-size: 8pt";
  ...
  this.mInlineFontStyle = "font-family: Verdana, Arial, Helvetica, sans-serif ; font-size: " + (WWHFrame.BaseNavFontSize-2) + "px";
