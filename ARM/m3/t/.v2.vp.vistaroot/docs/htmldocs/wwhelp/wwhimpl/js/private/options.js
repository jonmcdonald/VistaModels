...
//MGCRK - added code to determine UNIX vs PC to adjust text size
  textsize = WWHFrame.BaseNavFontSize;
...
//  this.mFontStyle = "font-family: Verdana, Arial, Helvetica, sans-serif ; font-size: 8pt";
  ...
  this.mNavigationFontStyle = "font-family: Verdana, Arial, Helvetica, sans-serif ; font-size: " + (WWHFrame.BaseNavFontSize-3) + "px";
...
//  }
  ...
  this.mbResultsByBook = false;
  this.mbShowRank      = true;
  this.mbLowLevel   = 39;
  this.mbMediumLevel     = 74;
}
