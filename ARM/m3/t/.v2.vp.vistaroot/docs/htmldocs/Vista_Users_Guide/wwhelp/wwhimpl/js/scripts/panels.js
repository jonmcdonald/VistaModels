...
function  WWHPanels_Object()
{
  ...
  // Add visible panels
  //
  //MGCRK added code to see if Index panel should be displayed
  //Writer sets this in README (HTML Include Index:)
  //Disabled 08/02/2004 RK
//  if (WWHFrame.IncludeIndex != "YES")
//  {
//     WWHFrame.WWHJavaScript.mSettings.mIndex.mbShow = false;
//  }
...
//////    this.mPanelEntries[this.mPanelEntries.length] = new WWHPanelsEntry_Object(WWHFrame.WWHSearch);
  ...
  if ((WWHFrame.WWHJavaScript.mSettings.mFavorites.mbShow) && (WWHFrame.EnableFavorites == "YES") )
  {
...
//  if ( (WWHFrame.WWHJavaScript.mSettings.mHistory.mbShow) && (WWHFrame.EnableHistory == "YES") )
//  {
//    WWHFrame.WWHHistory.mPanelTabIndex = this.mPanelEntries.length;
//    this.mPanelEntries[this.mPanelEntries.length] = new WWHPanelsEntry_Object(WWHFrame.WWHHistory);
//  }
}
