...
{
WWHFrame.ActiveTOC = ParamEntryID;
...
{
   EHTML = "";
   EHTML += "<table border=0 cellspacing=0 cellpadding=0><tr>";
   EHTML += "<td align=\"left\" width=18>";
   EHTML += "<img src=\"../../common/images/doc.png\" border=0 /></td>";
   EHTML += "<td><a href=\"javascript:WWHFrame.MGCOpenTab(1)\" >Index</a></td></tr></table>";
   return EHTML;
}
...
function  WWHOutlineImaging_GetIconURL(ParamEntry)
{
  ...
  if (ParamEntry.mChildren != null)
  {
    if (ParamEntry.mbExpanded)
    {
      ...
      {
        IconURL = this.mImageSrcDir + "wwhimpl/common/images/minus.png";
      }
    }
    else
    {
      ...
      {
        IconURL = this.mImageSrcDir + "wwhimpl/common/images/plus.png";
      }
    }
  }
  else
  {
    ...
    {
      IconURL = this.mImageSrcDir + "wwhimpl/common/images/doc.png";
    }
  }
...
function  WWHOutlineImaging_GetEntryHTML(ParamEntry)
{
  ...
  var  VarLink;
  var  Highlight = "";
//  if (WWHFrame.ActiveTOC == ParamEntry.mID)
//  {
//     Highlight = " bgcolor=\"\#0000CC\"";
//  }
...
//    EntryHTML += "<img width=\"17\" height=\"17\" border=\"0\" src=\"" + IconURL + "\">";
    EntryHTML += "<img border=\"0\" src=\"" + IconURL + "\">";
...
//    EntryHTML += "<td " + Highlight + " valign=\"top\">";
//    EntryHTML += "<nobr>";
...
//    EntryHTML += ParamEntry.mText + " " + ParamEntry.mID;
...
//    EntryHTML += "<img width=\"17\" height=\"17\" border=\"0\" src=\"" + IconURL + "\"></a>";
    EntryHTML += "<img border=\"0\" src=\"" + IconURL + "\"></a>";
    EntryHTML += "<img width=\"2\" height=\"1\" border=\"0\" src=\"" + this.mImageSrcDir + "wwhimpl/common/images/spc2w1h.gif\">";
