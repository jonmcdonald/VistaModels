...
function  WWHOutlineImagingSafe_GenerateStyles()
{
  ...
  var  MaxLevel;
  var  Level;
//border: solid red;font-weight: bold;
  ...
  StyleBuffer.fAppend("    color: #2652A2;\n");
  StyleBuffer.fAppend("    " + WWHFrame.WWHJavaScript.mSettings.mTOC.mFontStyle + ";\n");
  StyleBuffer.fAppend("  }\n");
  ...
  StyleBuffer.fAppend("    " + WWHFrame.WWHJavaScript.mSettings.mTOC.mFontStyle + ";\n");
  StyleBuffer.fAppend("    font-weight: bold;\n");
  StyleBuffer.fAppend("  }\n");
  StyleBuffer.fAppend("  a:focus\n");
  StyleBuffer.fAppend("  {\n");
  StyleBuffer.fAppend("    text-decoration: none;\n");
  StyleBuffer.fAppend("    background-color: " + WWHFrame.WWHJavaScript.mSettings.mTOC.mHighlightColor + ";\n");
  StyleBuffer.fAppend("    " + WWHFrame.WWHJavaScript.mSettings.mTOC.mFontStyle + ";\n");
  ...
  StyleBuffer.fAppend("    " + WWHFrame.WWHJavaScript.mSettings.mTOC.mFontStyle + ";\n");
  StyleBuffer.fAppend("  }\n");
  StyleBuffer.fAppend("  td\#on a:active {background-color:black;\n}");
  StyleBuffer.fAppend("  td\#on a:focus {background-color:black;\n}");
  StyleBuffer.fAppend("  td\#off a:active {background-color:white;\n}");
  StyleBuffer.fAppend("  td\#off a:focus {background-color:white;\n}");
  StyleBuffer.fAppend(" // -->\n");
