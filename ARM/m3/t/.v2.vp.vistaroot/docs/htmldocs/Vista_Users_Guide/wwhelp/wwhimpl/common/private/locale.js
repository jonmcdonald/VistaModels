...
function  WWHCommonMessages_Set_en(ParamMessages)
{
  ...
  ParamMessages.mPrevIconLabel           = "Display Previous Sequential Topic";
  ParamMessages.mNextIconLabel           = "Display Next Sequential Topic";
  ParamMessages.mRelatedTopicsIconLabel  = "Related Topics";
  ParamMessages.mEmailIconLabel          = "Submit Feedback on this document to Mentor Graphics";
