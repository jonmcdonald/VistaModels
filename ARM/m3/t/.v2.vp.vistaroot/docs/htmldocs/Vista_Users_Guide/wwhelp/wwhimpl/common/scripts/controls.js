...
//MGCRK - disable prev/next icons if popup or nav disabled
  ...
  this.fAddControl("WWHFrameSetIcon", this.fSansNavigation(), this.fSansNavigation(),
                   ...
                   "frameset.png", "frameset.png", "fClickedShowNavigation", "WWHControlsLeftFrame");
...
function  WWHControls_LeftHTML()
{
  ...
  if (this.fGetControl("WWHFrameSetIcon") != null)
  {
    ...
    VarHTML += " <tr>\n";
    //MGCRK added icon to switch to Topic-Only display (No Content/Index/Search tabs) and Home (title page) button
    var MGCHomeButton = "<td><a href=\"javascript:WWHFrame.MGC_GoToTitlePage()\"><img src=\"../images/home.png\" title=\"Display title page for this document\" border=\"0\" /></a></td><td>&nbsp;</td>\n";
    var MGCTopicURLButton = "<td><a href=\"javascript:WWHFrame.MGCView_TopicURL()\"><img src=\"../images/email_icon.gif\" width=\"23\" title=\"Email the link for this topic\" border=\"0\" /></a></td><td>&nbsp;</td>\n";
    var MGCSpaceButton = "<td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;</td>\n";
//    var mgcnotoc = "";
    var closebutton = "";
    if ((WWHFrame.popup != undefined) && (WWHFrame.popup == "YES"))
    {
       var closebutton = "<td><a href=\"javascript\:top.close\(\)\"><img src=\"../images/closesm.png\" title=\"Close Window\" border=\"0\"  /></a></td>\n";
    }
...
//    VarHTML += this.fGetControl("WWHSyncTOCIcon").fGetHTML();
    ...
    VarHTML += MGCSpaceButton;
//    VarHTML += MGCTopicURLButton;
    VarHTML += " </tr>\n";
    VarHTML += "</table>\n";
  }
  return VarHTML;
...
//  var DocumentFramePath = WWHFrame.MGCContent.MGCDocContent;
  ...
  mgcFontChange += "</td>\n";
  var mgcfeedback = "<td><a href=\"javascript:WWHFrame.SubmitFeedback()\"> <img src=\"../images/feedback.png\" title=\"Submit feedback on the currently displayed topic to Mentor Graphics\" border=\"0\"  /></a></td>\n";
  var mgcprint = "";
  ...
  {
       //RKMGC added the following variables to add the MGC logo, InfoHub icon, and PDF icon to the nav bar
       //Added code to check and see if certain icons should be disabled (help, pdf)
       var mgcpdf = "";
       var mgchelp = "";
       var mgcihub = "";
       MGCPopup = "NO";
       ...
       var mgchelp = "";
       if ((MGCPopup == "NO") && (WWHFrame.NavIconsEnabled == "ENABLE"))
       {
          var mgchelp = "<td><a href=\"javascript:WWHFrame.DisplayHelp(\'../../../../../mgc_html_help/mgc_html_help.htm\')\"><img src=\"../images/help.png\" title=\"Open quick tips and information on using this help system\" border=\"0\"  /></a></td>\n";
       }
       var mgclogo = "<td><img src=\"../images/mgc_logo.gif\" /></td>\n";
       if ((WWHFrame.IHUBHandle != "NONE") && (MGCPopup == "NO") && (WWHFrame.NavIconsEnabled == "ENABLE")  && (!WWHFrame.OnSupportNet) )
       {
          var mgcihub = "<td><a href=\"javascript:WWHFrame.OpenInfoHub()\"><img src=\"../images/infohub.png\" title=\"Display InfoHub\" border=\"0\"  /></a></td>\n";
       }
       if ((WWHFrame.PDFLink != "NO") && (MGCPopup == "NO") && (WWHFrame.NavIconsEnabled == "ENABLE"))
       {
          var mgcpdf = "<td><a href=\"javascript:WWHFrame.OpenPDF()\"><img src=\"../images/pdf.png\" title=\"Display current topic in PDF\" border=\"0\"  /></a></td>\n";
       }
       VarHTML += "<table border=\"0\">\n";
       VarHTML += " <tr>\n";
       VarHTML += this.fGetControl("WWHRelatedTopicsIcon").fGetHTML();
       //RKMGC added the following to add the PDF icon to the nav bar
...
//alert("Opening " + WWHFrame.WWHHelp.mHelpURLPrefix + "\n../wwhelp.htm?context=" + VarDocumentHandle + "&topic=" + VarDocumentTopic);
...
function  WWHControls_ClickedPrevious()
{
  ...
  if (!WWHFrame.WWHHelp.fSingleTopic())
  {
     var LastPage = WWHFrame.MGCContent.MGCDocContent.CurrentFile;
  }
  this.fRecordFocus("WWHControlsLeftFrame", "WWHPrevIcon");
  this.fPrevious();
  if ((!WWHFrame.WWHHelp.fSingleTopic()) && (WWHFrame.WWHJavaScript.mCurrentTab == "0"))
  {
     if (LastPage != "title1.html")
