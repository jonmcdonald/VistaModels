...
function  WWHCommonMessages_Set_en(ParamMessages)
{
  // Icon Labels
  //
  ParamMessages.mShowNavigationIconLabel = "Show Contents, Index, Search, My Topics Tabs";
  ParamMessages.mSyncIconLabel           = "Highlight this topic in the Contents tab";
  ParamMessages.mPrevIconLabel           = "Display PREVIOUS Topic in Table of Contents";
  ParamMessages.mNextIconLabel           = "Display NEXT Topic in Table of Contents";
  ParamMessages.mRelatedTopicsIconLabel  = "Related Topics";
  ParamMessages.mEmailIconLabel          = "Submit feedback on the currently displayed topic to Mentor Graphics";
  ParamMessages.mPrintIconLabel          = "Print This Topic";
