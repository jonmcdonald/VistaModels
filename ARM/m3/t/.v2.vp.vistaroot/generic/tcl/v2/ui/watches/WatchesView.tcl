...
body ::v2::ui::watches::WatchesView::update_gui/selectedNodeIDs {} {
  chain
...
namespace eval ::UI {
  ::itcl::class v2/ui/watches/WatchesView/DocumentLinker {
    inherit UI/TreeTable/DocumentLinker
  }
  v2/ui/watches/WatchesView/DocumentLinker v2/ui/watches/WatchesView/DocumentLinkerObject
}
