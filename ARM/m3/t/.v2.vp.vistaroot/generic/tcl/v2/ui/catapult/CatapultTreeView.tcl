namespace eval ::v2::ui::catapult {
  class CatapultTreeView {
    ...
    constructor {_document args} {
      ...
      ::UI::auto_trace_with_init variable [$document get_variable_name FlatCatapultTree] \
          w $itk_interior [::itcl::code $this set_flat]
    }

    private method set_flat {args} {
      set flat [$document get_variable_value FlatCatapultTree]
      $itk_component(table) configure -flat $flat
      if {!$flat} {
        open_tree 0 3
      }
    }
...
body ::v2::ui::catapult::CatapultTreeView::update_gui/selectedNodeIDs {} {  
  chain
...
namespace eval ::UI {
  ::itcl::class v2/ui/catapult/CatapultTreeView/DocumentLinker {
    inherit UI/TreeTable/DocumentLinker
  }
  v2/ui/catapult/CatapultTreeView/DocumentLinker v2/ui/catapult/CatapultTreeView/DocumentLinkerObject
}
