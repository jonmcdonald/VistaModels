...
body ::v2::ui::processes::LocalVariablesView::update_gui/selectedNodeIDs {} {  
  chain
...
namespace eval ::UI {
  ::itcl::class v2/ui/processes/LocalVariablesView/DocumentLinker {
    inherit UI/TreeTable/DocumentLinker
  }
  v2/ui/processes/LocalVariablesView/DocumentLinker v2/ui/processes/LocalVariablesView/DocumentLinkerObject
}
