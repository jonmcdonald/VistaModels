namespace eval ::UI {
  usual ::UI::FlushFileChooser {
  }
  # FileChooser with FlushEntry
  class FlushFileChooser {
    inherit itk::Widget 
    ...
    constructor {args} {
      ...
      frame $itk_interior.fr -relief sunken -borderwidth 1
      
      ### entry
      itk_component add entry {
        
        ::UI::FlushEntry $itk_interior.fr.ent -highlightthickness 1 -relief sunken -background white -borderwidth 1
      } {
        keep -state
...
#      puts "FlushFileChooser::OnFileSelection : error=$::errorInfo"
...
#        puts "FlushFileChooser called: ::UI::open_file_dialog $cmdname [DefineInitialPath] $dialogtitle $filetypes $itk_interior $with_multiple_select"
...
#        puts "FileChoser error=$::errorInfo"
  ...
  body ::UI::FlushFileChooser::check_new_value/directory {value} {
    return;
  }
  
  body ::UI::FlushFileChooser::update_gui/directory {} {
...
#          puts "::UI::FlushFileChooser::update_gui/directory : directory=$directory isOnFileSelectionDisabled=$isOnFileSelectionDisabled"
...
#    puts "update_gui/directory: isOnFileSelectionDisabled=$isOnFileSelectionDisabled"
  ...
  namespace eval ::UI {
    ::itcl::class UI/FlushFileChooser/DocumentLinker {
...
#      puts "error=$::errorInfo"
    ...
    UI/FlushFileChooser/DocumentLinker UI/FlushFileChooser/DocumentLinkerObject
  }
