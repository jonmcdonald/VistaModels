...
//This class inherits from the Low_MEM_pv_base class
class Low_MEM_pv : public Low_MEM_pv_base, public mb::models::memory_if::Invalidator {

 public:
  // Constructor
  // Do not add parameters here.
  // To add parameters - use the Model Builder form (under PV->Parameters tab)
  SC_HAS_PROCESS(Low_MEM_pv);
  Low_MEM_pv(sc_module_name module_name); 
