...
#include "APB_AXI_model.h"

using namespace tlm;

//This class inherits from the APB_AXI_pv_base class
class APB_AXI_pv : public APB_AXI_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(APB_AXI_pv);
  APB_AXI_pv(sc_core::sc_module_name module_name);   
