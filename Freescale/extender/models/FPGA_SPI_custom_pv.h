...
#include "FPGA_SPI_custom_model.h"

using namespace tlm;

//This class inherits from the FPGA_SPI_custom_pv_base class
class FPGA_SPI_custom_pv : public FPGA_SPI_custom_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(FPGA_SPI_custom_pv);
  FPGA_SPI_custom_pv(sc_core::sc_module_name module_name);    
