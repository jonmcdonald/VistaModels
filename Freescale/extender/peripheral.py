...
#            lt3Canvas.itemconfigure(lt3LED, fill=colors[l3])
	...
	swvals = {0:iswdn, 1:iswup}
        ...
        global lt0Canvas
	global lt0LED
	lt0Canvas = Tkinter.Canvas(self, width=32, height=32)
	lt0LED = lt0Canvas.create_oval(2, 2, 30, 30, fill="#000")
        lt0Canvas.grid(column=0,row=0)
        global lt1Canvas
	global lt1LED
	lt1Canvas = Tkinter.Canvas(self, width=32, height=32)
	lt1LED = lt1Canvas.create_oval(2, 2, 30, 30, fill="#000")
        lt1Canvas.grid(column=1,row=0)
        global lt2Canvas
	global lt2LED
	lt2Canvas = Tkinter.Canvas(self, width=32, height=32)
	lt2LED = lt2Canvas.create_oval(2, 2, 30, 30, fill="#000")
        lt2Canvas.grid(column=2,row=0)
        global lt3Canvas
	global lt3LED
	lt3Canvas = Tkinter.Canvas(self, width=32, height=32)
	lt3LED = lt3Canvas.create_oval(2, 2, 30, 30, fill="#000")
