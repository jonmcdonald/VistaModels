...
$init("ECSPI0_IN0"),
ECSPI0_IN0("ECSPI0_IN0")
$end
$init("ECSPI0_IN1"),
ECSPI0_IN1("ECSPI0_IN1")
$end
$init("ECSPI0_IN2"),
ECSPI0_IN2("ECSPI0_IN2")
$end
$init("ECSPI0_IN3"),
ECSPI0_IN3("ECSPI0_IN3")
$end
$init("GPIO0_IN0"),
GPIO0_IN0("GPIO0_IN0")
$end
...
$end
$init("ECSPI0_OUT0"),
ECSPI0_OUT0("ECSPI0_OUT0")
$end
$init("ECSPI0_OUT1"),
ECSPI0_OUT1("ECSPI0_OUT1")
$end
$init("ECSPI0_OUT2"),
ECSPI0_OUT2("ECSPI0_OUT2")
$end
$init("ECSPI0_OUT3"),
ECSPI0_OUT3("ECSPI0_OUT3")
$end
$init("GPIO0_OUT0"),
GPIO0_OUT0("GPIO0_OUT0")
$end
$init("GPIO0_OUT1"),
GPIO0_OUT1("GPIO0_OUT1")
$end
$init("AHB_BUS"),
AHB_BUS(0)
$end
...
$end;
$bind("I2C2->i2c_bus","I2C2_Bus");
vista_bind(I2C2->i2c_bus, I2C2_Bus);
$end;
$bind("I2C3->i2c_bus","I2C3_Bus");
vista_bind(I2C3->i2c_bus, I2C3_Bus);
$end;
$bind("ECSPI0_IN3","ECSPI1->Data_IN3");
vista_bind(ECSPI0_IN3, ECSPI1->Data_IN3);
$end;
$bind("ECSPI0_IN2","ECSPI1->Data_IN2");
vista_bind(ECSPI0_IN2, ECSPI1->Data_IN2);
$end;
$bind("ECSPI0_IN1","ECSPI1->Data_IN1");
vista_bind(ECSPI0_IN1, ECSPI1->Data_IN1);
$end;
$bind("ECSPI0_IN0","ECSPI1->Data_IN0");
vista_bind(ECSPI0_IN0, ECSPI1->Data_IN0);
$end;
$bind("ECSPI1->Data_OUT0","ECSPI0_OUT0");
vista_bind(ECSPI1->Data_OUT0, ECSPI0_OUT0);
$end;
$bind("ECSPI1->Data_OUT1","ECSPI0_OUT1");
vista_bind(ECSPI1->Data_OUT1, ECSPI0_OUT1);
$end;
$bind("ECSPI1->Data_OUT3","ECSPI0_OUT3");
vista_bind(ECSPI1->Data_OUT3, ECSPI0_OUT3);
$end;
$bind("ECSPI1->Data_OUT2","ECSPI0_OUT2");
vista_bind(ECSPI1->Data_OUT2, ECSPI0_OUT2);
$end;
$bind("GPIO0_IN1","GPIO1->gpio_in_1");
vista_bind(GPIO0_IN1, GPIO1->gpio_in_1);
$end;
$bind("GPIO0_IN0","GPIO1->gpio_in_0");
vista_bind(GPIO0_IN0, GPIO1->gpio_in_0);
$end;
$bind("GPIO1->gpio_out_0","GPIO0_OUT0");
vista_bind(GPIO1->gpio_out_0, GPIO0_OUT0);
$end;
$bind("GPIO1->gpio_out_1","GPIO0_OUT1");
vista_bind(GPIO1->gpio_out_1, GPIO0_OUT1);
$end;
    $elaboration_end;
  $vlnv_assign_begin;
...
public:
  $fields_begin;
$socket("ECSPI0_IN0");
tlm::tlm_target_socket< 32U,tlm::tlm_base_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > ECSPI0_IN0;
$end;
$socket("ECSPI0_IN1");
tlm::tlm_target_socket< 32U,tlm::tlm_base_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > ECSPI0_IN1;
$end;
$socket("ECSPI0_IN2");
tlm::tlm_target_socket< 32U,tlm::tlm_base_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > ECSPI0_IN2;
$end;
$socket("ECSPI0_IN3");
tlm::tlm_target_socket< 32U,tlm::tlm_base_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > ECSPI0_IN3;
$end;
$socket("GPIO0_IN0");
tlm::tlm_target_socket< 1U,tlm::tlm_base_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > GPIO0_IN0;
$end;
$socket("GPIO0_IN1");
...
$end;
$socket("I2C2_Bus");
tlm::tlm_initiator_socket< 8U,i2c_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > I2C2_Bus;
$end;
$socket("I2C3_Bus");
tlm::tlm_initiator_socket< 8U,i2c_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > I2C3_Bus;
$end;
$socket("ECSPI0_OUT0");
tlm::tlm_initiator_socket< 32U,tlm::tlm_base_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > ECSPI0_OUT0;
$end;
$socket("ECSPI0_OUT1");
tlm::tlm_initiator_socket< 32U,tlm::tlm_base_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > ECSPI0_OUT1;
$end;
$socket("ECSPI0_OUT2");
tlm::tlm_initiator_socket< 32U,tlm::tlm_base_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > ECSPI0_OUT2;
$end;
$socket("ECSPI0_OUT3");
tlm::tlm_initiator_socket< 32U,tlm::tlm_base_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > ECSPI0_OUT3;
$end;
$socket("GPIO0_OUT0");
tlm::tlm_initiator_socket< 1U,tlm::tlm_base_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > GPIO0_OUT0;
$end;
$socket("GPIO0_OUT1");
tlm::tlm_initiator_socket< 1U,tlm::tlm_base_protocol_types,1,sc_core::SC_ZERO_OR_MORE_BOUND > GPIO0_OUT1;
$end;
$component("AHB_BUS");
ahb_bus_pvt *AHB_BUS;
$end;
